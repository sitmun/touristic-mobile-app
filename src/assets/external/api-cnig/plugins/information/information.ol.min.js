(() => {
  var t = {
      ...
      262: (t) => {
        t.exports =
          '<div class="m-information-content">\n   {{{info}}}\n</div>\n';
      },
      431: (t, e, n) => {
        t.exports =
          '<div>\n   <h2 style="text-align: center; color: #fff; background-color: #364b5f; padding: 8px 10px;">INFORMATION <img style="vertical-align: bottom; filter: invert(100%);" src="' +
          n(914) +
  ...
  (n.n = (t) => {
    ...
    (() => {
      "use strict";
      const t = JSON.parse(
        '{"Pu":{"name":"Information","description":"Shows getfeatureinfo onclick when active","text":"On click in a queryable layer shows getfeatureinfo","version":"2.0.1","date":"09/12/2019","author":"Guadaltel","org":"CNIG","tags":"mapea,plugin","icon":"./facade/assets/icons/icon.svg"}}'
      );
      var e = n(431),
        o = n.n(e),
        r = n(262),
          ...
          var e,
            n =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : ((e = "es"),
                  "function" == typeof M.language.getLang &&
                    (e = M.language.getLang()),
                  e),
            o = (function (t) {
              return "es" === t || "en" === t
                ? u[t]
                : M.language.getTranslation(t).information;
            })(n),
            r = "";
          return (
            M.utils.isNullOrEmpty(o)
              ? console.warn(
                  "The translation '".concat(n, "' has not been defined.")
                )
              : (r = t.split(".").reduce(function (t, e) {
                  return t[e];
                }, o)),
            r
          );
      ...
      function v(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (o.enumerable = o.enumerable || !1),
            ...
            Object.defineProperty(t, g(o.key), o);
        }
      }
      function g(t) {
        var e = (function (t, e) {
            ...
            "undefined" != typeof Reflect && Reflect.get
              ...
              : function (t, e, n) {
                  var o = (function (t, e) {
                    for (
                      ;
                      !{}.hasOwnProperty.call(t, e) && null !== (t = _(t));
        ...
        L = (function () {
          function t(e, n, o, r) {
            ...
            return (
              ...
              ((i = b(this, t, [{}])).format_ = e),
              "plain" === M.utils.normalize(i.format_) ||
              "text/plain" === M.utils.normalize(i.format_)
                ? (i.format_ = "text/plain")
                : "gml" === M.utils.normalize(i.format_) ||
                  "application/vnd.ogc.gml" === M.utils.normalize(i.format_)
                ? (i.format_ = "application/vnd.ogc.gml")
                : (i.format_ = "text/html"),
              (i.featureCount_ = n),
              (i.buffer_ = o),
              (i.opened_ = r),
          ...
          return (
            ...
            (n = [
              ...
              {
                key: "deleteOnClickEvent_",
                value: function () {
                  ol.Observable.unByKey(this.clickEventKey_),
                    document
                      .querySelector(
                        ".m-control.m-container.m-information-container"
                      )
                      .classList.remove("activated");
                },
              },
              {
                key: "addOnClickEvent_",
                value: function () {
                  var t = this,
                    e = this.facadeMap_.getMapImpl();
                  (this.clickEventKey_ = e.on("singleclick", function (e) {
                    return t.buildUrl_(M.dialog, e);
                  })),
                    document
                      .querySelector(
                        ".m-control.m-container.m-information-container"
              ...
              },
              {
                ...
                value: function (t, e) {
                  this.evt = e;
                  var n = this.facadeMap_.getMapImpl(),
                    o = y(this.buildGenericInfoURL(), 2),
                    r = o[0],
                    i = o[1],
                    a = [].concat(
                      m(this.facadeMap_.getImpl().getAllLayerInGroup()),
                      m(this.facadeMap_.getLayers())
                    ),
                    ...
                    s = this.buildWMSInfoURL([].concat(m(l), m(i))),
                    u = this.buildWMTSInfoURL([].concat(m(c), m(r))),
                    f = [].concat(m(u), m(s)).filter(function (t) {
                      return !M.utils.isNullOrEmpty(t);
                    });
                  f.length > 0
                    ? this.showInfoFromURL_(f, e.coordinate, n)
                    : t.info(p("not_queryable"));
                },
              },
              {
                key: "buildWMSInfoURL",
                value: function (t) {
                  var e = this,
                    n = this.facadeMap_.getMapImpl().getView().getResolution(),
                    o = this.facadeMap_.getProjection().code;
                  return t.map(function (t) {
                    var r,
                      i = t.getImpl().getOL3Layer();
                    if (
                      t.isVisible() &&
                      t.isQueryable() &&
                      !M.utils.isNullOrEmpty(i)
                    ) {
                      r = {};
                      var a = {
                          INFO_FORMAT: e.format_,
                          FEATURE_COUNT: e.featureCount_,
                        },
                        l = i.getSource(),
                        c = e.evt.coordinate;
                      /buffer/i.test(t.url) || (a.BUFFER = e.buffer_);
                      var s = l.getFeatureInfoUrl(c, n, o, a);
                      r = { layer: t.legend || t.name, url: s };
                    }
                    return r;
                  });
                },
                ...
                value: function (t) {
                  ...
                  return t.map(function (t) {
                    ...
                    if (
                      t.isVisible() &&
                      t.isQueryable() &&
                      !M.utils.isNullOrEmpty(t)
                    ) {
                      n = {};
                      var o = e.format_,
                        r = e.evt.coordinate,
                        i = t
                          .getFeatureInfoUrl(r, e.facadeMap_.getZoom(), o)
                          .replace("row=-", "row=");
                      n = { layer: t.legend || t.name, url: i };
                    }
                    return n;
                  });
                },
              },
              {
                ...
                value: function () {
                  var t = []
                      ...
                      .filter(function (t) {
                        return "GenericRaster" === t.type;
                      }),
                    e = [],
                    n = [];
                  return (
                    t.forEach(function (t) {
                      t.getImpl().getOL3Layer().getSource() instanceof
                      ol.source.WMTS
                        ? e.push(t)
                        : (t.getImpl().getOL3Layer().getSource() instanceof
                            ol.source.TileWMS ||
                ...
                value: function (t, e, n) {
                  ...
                  switch (e) {
                    ...
                    case "application/vnd.ogc.gml":
                      var r = new ol.format.WFS().readFeatures(t);
                      (o = ""),
                        r.forEach(function (t) {
                          var e = t.getKeys();
                          (o += "<div class='divinfo'>"),
                            (o +=
                              "<table class='mapea-table'><tbody><tr><td class='header' colspan='3'>' ".concat(
                                M.utils.beautifyAttribute(n),
                                " '</td></tr>'"
                              ));
                          for (var r = 0, i = e.length; r < i; r += 1) {
                            var a = e[r],
                              l = t.get(a);
                            (o += '<tr><td class="key"><b>'),
                              (o += M.utils.beautifyAttribute(a)),
                              (o += '</b></td><td class="value">'),
                              (o += l),
                              (o += "</td></tr>");
                          }
                          o += "</tbody></table></div>";
                      ...
                      break;
                    case "text/plain":
                      o = I.gsResponse.test(t)
                        ? this.txtToHtmlGeoserver(t, n)
                        : this.txtToHtmlMapserver(t, n);
                  }
                  return o;
                },
              },
              {
                key: "txtToHtmlGeoserver",
                value: function (t, e) {
                  var n = t,
                    o = (n = (n = n.replace(/[\w\s\S]*':/i, "")).replace(
                      /---(-*)(n+)---(-*)/g,
                      "#newfeature#"
                    )).split("\n"),
                    r = "<div class='divinfo'>";
                  ...
                  for (var i = 0, a = o.length; i < a; i += 1) {
                    ...
                    if (-1 !== l.indexOf("=")) {
                      var c = l.split("="),
                        ...
                        u = "-";
                      c.length > 1 &&
                        ((0 !== (u = c[1].trim()).length && "null" !== u) ||
                          (u = "-")),
                        !1 === I.gsGeometry.test(s) &&
                          ((r += '<tr><td class="key"><b>'),
                          (r += M.utils.beautifyAttribute(s)),
                          (r += '</b></td><td class="value">'),
                          (r += u),
                          (r += "</td></tr>"));
                    } else
                      I.gsNewFeature.test(l) &&
                        (r += '<tr><td class="header" colspan="3">'.concat(
                          M.utils.beautifyAttribute(e),
                          "</td></tr>"
                        ));
                  }
              ...
              {
                key: "txtToHtmlMapserver",
                value: function (t) {
                  for (
                    var e = t,
                      n = (e = e.replace(/[\w\s\S]*(layer)/i, "$1")).replace(
                        /layer(\s*)'(\w+)'[\w\s\S]*/i,
                        "$2"
                      ),
                      o = (e = (e = (e = (e = e.replace(
                    ...
                    var c = o[a].trim(),
                      ...
                      p = u[0].trim(),
                      f = "-";
                    u.length > 1 && 0 === (f = u[1].trim()).length && (f = "-"),
                      p.length > 0 &&
                        (I.msNewFeature.test(p)
                          ? s.length > 0 &&
                            !I.msNewFeature.test(s) &&
                            (r += "<tr><td class='header' colspan='3'>".concat(
                              M.utils.beautifyAttribute(n),
                              "</td><td></td></tr>"
                            ))
                          : ((r += '<tr><td class="key"><b>'),
                            (r += M.utils.beautifyAttribute(p)),
                            (r += '</b></td><td class="value">'),
                            (r += f),
                            (r += "</td></tr>")));
                  }
                  return (
                    r.length > 0 && (r = "".concat(i + r, "</tbody></table>")),
                    r
                  );
                },
              },
              {
                key: "showInfoFromURL_",
                value: function (e, n, o) {
                  var r = this,
                    a = M.template.compileSync(i(), {
                      vars: { info: p("querying") },
                      parseToHtml: !1,
                    }),
                    c = [],
                    s = String(this.format_),
                    u = 0,
                    f = { icon: "g-cartografia-info", title: T, content: a },
                    m = this.facadeMap_.getPopup();
                  M.config.MOVE_MAP_EXTRACT &&
                    (M.config("MOVE_MAP_EXTRACT", !1), (this.popupMove_ = !0)),
                    M.utils.isNullOrEmpty(m)
                      ? ((m = new M.Popup()).addTab(f),
                        this.facadeMap_.addPopup(m, n))
                      : m.getTabs().some(function (t) {
                          return t.title !== T;
                        })
                      ? m.addTab(f)
                    ...
                    e.forEach(function (n) {
                      ...
                      M.remote
                        .get(o)
                        .then(function (n) {
                          if (((m = r.facadeMap_.getPopup()), 200 === n.code)) {
                            var o = r.parseCSSInfo(n.text);
                            if (!0 === t.insert(o, s)) {
                              var a = r.formatInfo(o, s, i);
                              c.push({ formatedInfo: a, layerName: i });
                            } else
                              t.unsupportedFormat(o, s) &&
                                c.push({
                                  formatedInfo: p("unsupported_format"),
                                  layerName: i,
                                });
                          }
                          if (
                            ((u += 1),
                            e.length === u && !M.utils.isNullOrEmpty(m))
                          )
                            if ((m.removeTab(f), 0 === c.length))
                              m.addTab({
                              ...
                              var y = M.template.compileSync(l(), {
                                vars: { layers: c, info_of: p("info_of") },
                                parseToHtml: !1,
                              });
                              m.addTab({
                                icon: "g-cartografia-info",
                                ...
                                listeners: [
                                  {
                                    selector:
                                      ".m-information-content-info div.m-arrow-right",
                                    all: !0,
                                    type: "click",
                                    callback: function (t) {
                                      return r.toogleSection(t);
                                    },
                                  },
                                  {
                                    selector:
                                      ".m-information-content-info div:nth-child(2) p",
                                    all: !0,
                                    type: "click",
                                    callback: function (t) {
                                      return r.toogleSection(t);
                                ...
                                "all" === r.opened_
                                  ? setTimeout(function () {
                                      document
                                        .querySelectorAll(
                                          ".m-information-content-info-body"
                                        )
                                        .forEach(function (t) {
                                          t.classList.remove(
                                            "m-content-collapsed"
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  n.classList.contains("m-information-content-info") ||
                    (e = (n = n.classList.contains(
                      "m-information-content-info-header"
                    )
                      ? n.parentElement
                      : n.parentElement.parentElement).querySelector(
                      ".m-information-content-info-header div:nth-child(1)"
                    ));
                  var o = n.querySelector(".m-information-content-info-body");
                  if (o.classList.contains("m-content-collapsed")) {
                    o.classList.remove("m-content-collapsed"),
                      e.classList.remove("m-arrow-right"),
                      e.classList.add("m-arrow-down");
                    var r = this.popup_.getCoordinate();
                    this.popup_.getImpl().panIntoView(r);
                  } else
                    o.classList.add("m-content-collapsed"),
                      e.classList.add("m-arrow-right"),
                      e.classList.remove("m-arrow-down");
                },
              },
              {
                key: "movePopup_",
                value: function (t) {
                  ...
                  if (this.popupMove_ && window.innerWidth > 768) {
                    var n = M.utils.returnPositionHtmlElement("m-popup", t);
                    setTimeout(function () {
                      t
                        .getMapImpl()
                        .getView()
                        ...
                        e.popupMove_ && M.config("MOVE_MAP_EXTRACT", !0),
                        (e.popupMove_ = !1);
                    }, 100);
                  }
                },
              ...
              },
              {
                ...
                value: function (t) {
                  var e = t;
                  try {
                    if (t.indexOf('<style type="text/css">') > -1) {
                      var n = t.split('<style type="text/css">')[0],
                        o = t
                        ...
                        if (t.indexOf("}") > -1) {
                          ...
                          0 === n.length
                            ...
                            : ((n = n
                                .split(",")
                                .join(
                                  ", .m-information-content-info .m-information-content-info-body"
                                )),
                              (i += ""
                                .concat(
                                  e,
                          ...
                          i +=
                            ".m-information-content-info .m-information-content-info-body ".concat(
                              o,
                              " {"
                            );
                        }
                    ...
                    if (e.indexOf('<link rel="stylesheet"') > -1) {
                      var a = e.split('<link rel="stylesheet"')[0],
                        l = e
                          .split('<link rel="stylesheet"')[1]
                          .split('.css">')[1];
                      e = a + l;
                    }
                  } catch (n) {
            ...
            (o = [
                  ...
                  switch (e) {
                    case "text/html":
                      ...
                      Array.prototype.forEach.call(
                        ...
                        Array.prototype.forEach.call(
                          o.querySelectorAll("b"),
                          function (t) {
                            r += t.innerHTML.trim();
                          }
                        ),
                        Array.prototype.forEach.call(
                          o.querySelectorAll("span"),
                          function (t) {
                            r += t.innerHTML.trim();
                          }
                        ),
                        ...
                        r.length > 0 &&
                          !/WMS\s+server\s+error/i.test(t) &&
                          (n = !0);
                      break;
                    case "application/vnd.ogc.gml":
                      n = new ol.format.WFS().readFeatures(t).length > 0;
                      break;
                    case "text/plain":
                      /returned\s+no\s+results/i.test(t) ||
                        /features\s+were\s+found/i.test(t) ||
                        /:$/i.test(t) ||
                        (n = !0);
                  }
                  return n;
              ...
              },
              {
                ...
                value: function (t, e) {
                  var n = !1;
                  return (
                    "text/html" === e && (n = I.msUnsupportedFormat.test(t)), n
                  );
                },
              },
            ]),
      ...
      var P = (function () {
        function t(e, n, o, r, i, a) {
          ...
          return (
            ...
            M.utils.isUndefined(L) && M.exception(""),
            ((l = x(this, t, [new L(e, n, o, i), "Information"])).tooltip = r),
            (l.order = a),
            l
          );
        }
          ...
          (n = [
            {
              ...
              value: function (t) {
                ...
                return new Promise(function (t, n) {
                  t(
                    M.template.compileSync(O(), {
                      vars: {
                        translations: { tooltip: e.tooltip || p("tooltip") },
                        order: e.order,
                      },
                    })
                  );
              ...
              value: function () {
                this.invokeEscKey(),
                  ...
                  (document.body.style.cursor =
                    "url('https://i.ibb.co/HBtH3Qs/click-info.png') 1 7, auto"),
                  document.addEventListener(
                    "keyup",
                    this.checkEscKey.bind(this)
                  );
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t) {
                return t.querySelector("#m-information-btn");
              },
            },
            {
              key: "equals",
      ...
      var W = (function () {
        function e(n) {
          ...
          return (
            ...
            ((o = H(this, e)).map_ = null),
            (o.controls_ = []),
            (o.position_ = n.position || "TR"),
            (o.tooltip_ = n.tooltip || p("tooltip")),
            (o.format_ = n.format || "text/html"),
            (o.featureCount_ = n.featureCount || 99),
            (o.buffer_ = n.buffer || 10),
            (o.opened_ = n.opened || "closed"),
            (o.name_ = "information"),
            (o.metadata_ = t.Pu),
            (o.order = n.order >= -1 ? n.order : null),
            (o.options = n),
            o
          );
        }
          ...
          (r = [
            ...
            },
            {
              ...
              value: function () {
                var t = ""
                  .concat(this.name_, "=")
                  .concat(this.position_, "*")
                  .concat(this.tooltip_, "*")
                  .concat(this.format_, "*")
                  .concat(this.featureCount_);
                return (
                  void 0 === this.buffer_ ||
                  null === this.buffer_ ||
                  "" === this.buffer_
                    ? (t += "*")
                    : (t += "*".concat(this.buffer_)),
                  void 0 === this.opened_ ||
                  null === this.opened_ ||
                  "" === this.opened_
                    ? (t += "*")
                    : (t += "*".concat(this.opened_)),
                  t
                );
              },
            },
            {
              ...
              value: function () {
                return ""
                  .concat(this.name, "=base64=")
                  .concat(M.utils.encodeBase64(this.options));
              },
            },
            {
              key: "getHelp",
              value: function () {
                return {
                  title: this.name,
                  content: new Promise(function (t) {
                    t(
                      M.template.compileSync(o(), {
                        vars: {
                          urlImages: "".concat(
                            M.config.MAPEA_URL,
                            "plugins/information/images/"
                          ),
                          translations: {
                            help1: p("textHelp.help1"),
                            help2: p("textHelp.help2"),
                            help3: p("textHelp.help3"),
                            help4: p("textHelp.help4"),
                            help5: p("textHelp.help5"),
                            help6: p("textHelp.help6"),
                            help7: p("textHelp.help7"),
                          },
                        },
                      })
                    );
      ...
      window.M.plugin || (window.M.plugin = {}),
        window.M.control || (window.M.control = {}),
        window.M.impl || (window.M.impl = {}),
        window.M.impl.control || (window.M.impl.control = {}),
        (window.M.plugin.Information = W),
        (window.M.control.InformationControl = P),
